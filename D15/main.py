...
def deduct_resources(coffee_choice):
    ...
    if coffee_choice != 'espresso':
        ...
        # this function didn't return anything but still process the data, resources data
...
def coffee_machine():
    ...
    while on:
        ...
        if choice == 'report':
            report()
            coffee_machine()
            # if user input report() and then show the report then call coffee_machine() again
            # AKA run the coffee_machine again.
        elif choice == 'off':
            print("Turning off.")
            on = False
...
coffee_machine()
# coffee_machine() function only happen in coffee_machine function, once the data inside the coffee_machine 
# function. It would process the coffee machine data like a loop